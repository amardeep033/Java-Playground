...
public class ProductService {
    ...
    // In 01 this returned Optional<Product>; in 02 service throws when the product is missing.
    public Product getProductById(Long id) {
        return productRepository.findById(id)
                .orElseThrow(() -> new ProductNotFoundException(id));
        // orElseThrow converts Optional.empty() into ProductNotFoundException.
    }
