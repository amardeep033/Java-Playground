...
public class ProductController {
    ...
    public ProductResponse getProductById(@PathVariable Long id) {
        ...
        // In 01, service returned Optional<Product>, so controller mapped found/missing cases manually.
        // In 02, service either returns Product or throws ProductNotFoundException.
    ...
    public ProductResponse updateProduct(@PathVariable Long id, @Valid @RequestBody ProductRequest request) {
        ...
        // In 01, update returned Optional<Product> and controller built 404 inline.
        // In 02, update returns Product or throws ProductNotFoundException.
